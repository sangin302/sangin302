...
- 🥇 **SSAFY 관통 프로젝트 우수상 - SeedBank**
- 🥇 **SSAFY 특화 프로젝트 우수상 - 우리들의 비밀장터(OSM)**
- 🥇 **SSAFY 자율 프로젝트 우수상 - SSAIREN**
- 🥇 **KOPIS 빅데이터 공모전 혁신상(1등) - 복합 장르 공연 콘텐츠의 수익성과 확장 가능성 분석; 공연시장 다양성과 지속 가능성을 위한 전략 제안**
